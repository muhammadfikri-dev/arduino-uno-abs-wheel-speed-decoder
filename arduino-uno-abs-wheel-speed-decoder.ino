/**
 * =========================================================================================
 * Project     : Arduino Uno Automotive ABS Hall Wheel Speed Sensor Pulse Decoder
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Automotive safety test bench measuring 4-wheel active Hall-effect wheel speed sensors, calculating vehicle velocity, slip ratio, and simulating ABS pulse modulation.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno Automotive ABS Hall Wheel Speed Sensor Pulse Decoder"));
