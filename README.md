# ⚡ Arduino Uno Automotive ABS Hall Wheel Speed Sensor Pulse Decoder
...
Automotive safety test bench measuring 4-wheel active Hall-effect wheel speed sensors, calculating vehicle velocity, slip ratio, and simulating ABS pulse modulation.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `EEPROM`
4. Buka berkas [`arduino-uno-abs-wheel-speed-decoder.ino`](./arduino-uno-abs-wheel-speed-decoder.ino).
